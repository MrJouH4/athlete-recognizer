...
def load_artifacts():
    ...
    global __model
    if __model is None:
        with open("server/artifacts/lr_saved_model.pkl", "rb") as f:
...
if __name__ == "__main__":
    ...
    # print(classify_image(get_b64_test_image_virat(), "../model/test_images/messi_and_wife.jpg"))
    # print(classify_image(get_b64_test_image_virat(), "../model/test_images/roger.webp"))
    # print(classify_image(get_b64_test_image_virat(), "../model/test_images/sharapova1.jpg"))
    # print(classify_image(get_b64_test_image_virat(), "../model/test_images/sharapova2.JPG"))
